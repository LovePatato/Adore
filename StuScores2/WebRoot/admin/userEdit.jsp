...
$(document).ready(function(){
	 ...
	 $("#addBtn").bind('click',function(){
		...
		if($("#paramsUser\\.clazz\\.clazz_id").val()=='0'){
			alert('班级不能为空');
			return;
		}
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
        ...
        <tr>
          ...
          <td colspan="3">
          	<s:select name="paramsUser.clazz.clazz_id" id="paramsUser.clazz.clazz_id" list="#attr.clazzs" value="%{#attr.user.clazz.clazz_id}" listKey="clazz_id" listValue="clazz_name" headerKey="0" headerValue="请选择" cssStyle="width:155px"></s:select>
          </td>
        </tr>
     </table>
     </td>
