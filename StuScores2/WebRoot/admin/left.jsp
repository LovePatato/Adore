			 ...
			 <table width="100%" height="280" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
			  <tr>
				...
				<div id="container">
				  ...
				  <c:if test="${admin.user_type==3}">
				  <h1 class="type"><a href="javascript:void(0)">教学计划</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
				  ...
				  <div class="content">
				   ...
				   <!--add start-->
					...
					<c:if test="${admin.user_type ==2}">
						<h1 class="type"><a href="javascript:void(0)">成绩统计</a></h1>
						<div class="content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
							...
							<ul class="MM">
								<li><a href="Admin_listSingleScores.action" target="MainFrame">单科成绩排名</a></li>
								<li><a href="Admin_listSingleScoresSectionShow.action" target="MainFrame">单科成绩分布</a></li>
								<li><a href="Admin_singleScoresStudent.action" target="MainFrame">折线图</a></li>
							</ul>
						</div>
					</c:if>
